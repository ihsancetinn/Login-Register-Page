  ...
  const handleSubmit = async (e) => {
    ...
    if (name !== "" && email !== "" && password !== "") {
      ...
      await axios
        ...
        .catch((error) => {
          console.log(error)
          setMessage("Kullanıcı Kayıt Edilemedi")
          setTimeout(() => {
            setMessage("");
            setLoading(false)
          }, 2500)
  ...
  return (
    <>
      ...
      <div className={styles.formContainer}>
        <h3>Hoşgeldiniz </h3>
        <h2>Kayıt İçin Form Doldurun</h2>
        ...
        <form onSubmit={(e) => handleSubmit(e)}>
          ...
          <button type="submit">
            {loading ? "Yükleniyor.." : "Register"}
          </button>
          <p>Zaten Üye misiniz ?   <b onClick={handlerSubmit}>Giriş Sayfası İçin Tıklayınız</b></p>
